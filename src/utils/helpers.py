...
class QuizManager:
    ...
    def attempt_quiz(self):
        # Initialize user_answers list if it doesn't match the number of questions
        ...
        for i,q in enumerate(self.questions):
            ...
            if q['type']=='MCQ':
                ...
                # Update the answer by index (not append) - this preserves user selection
                ...
                # Update the answer by index (not append) - this preserves user input
                self.user_answers[i] = user_answer
